...
import { EmptyCard, FieldLabel } from '@/components/health/EmptyCard';
  ...
  return (
    <View style={{ backgroundColor: colors.card, borderRadius: 16, overflow: 'hidden',
      ...
      <View style={{ flexDirection: 'row', alignItems: 'flex-end', padding: 16, gap: 16 }}>
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 14, fontWeight: '700', color: colors.textTertiary, letterSpacing: 0.5, marginBottom: 4 }}>
            CURRENT WEIGHT
          </Text>
          <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 4 }}>
            ...
            <Text style={{ fontSize: 14, fontWeight: '600', color: colors.textSecondary }}>{unitLabel}</Text>
          </View>
          {deltaStr && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 }}>
              ...
              <Text style={{ fontSize: 14, fontWeight: '700', color: deltaCol }}>
          ...
          {deltaAllStr && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 }}>
              ...
              <Text style={{ fontSize: 14, color: deltaAllCol }}>
          ...
          <View style={[ss.sheet, { backgroundColor: colors.surface }]}>
            ...
            <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}
                ...
                {(['kg', 'lb'] as const).map(u => {
                  ...
                  return (
                    <TouchableOpacity key={u}
                      ...
                      <Text style={{ fontSize: 14, fontWeight: '700', color: sel ? accent : colors.textSecondary }}>
                        {u.toUpperCase()}
                      </Text>
                    </TouchableOpacity>
                  );
              ...
              <TextInput
                ...
                returnKeyType="done"
              />
              <Text style={{ textAlign: 'center', color: colors.textSecondary, fontSize: 14, marginTop: 4 }}>
