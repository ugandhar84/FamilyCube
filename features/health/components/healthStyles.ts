...
export function styles(colors: any, accent: string) {
  return StyleSheet.create({
    ...
    qaCard:  { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 16, backgroundColor: colors.card, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6 }, android: { elevation: 2 } }) },
    ...
    // ── Grouped card ──
    card: { backgroundColor: colors.card, borderRadius: 16, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6 }, android: { elevation: 2 } }) },
    ...
    // ── Medication cards ──
    medCard:         { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 14, paddingVertical: 14, backgroundColor: colors.card, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6 }, android: { elevation: 2 } }) },
    ...
    // ── Vaccine chips ──
    vaxChip:     { width: 118, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, padding: 14, backgroundColor: colors.card, alignItems: 'center', ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6 }, android: { elevation: 2 } }) },
    ...
    // ── FurAI banner ──
    furaiBanner: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 20, borderWidth: 1, borderRadius: 18, padding: 16, ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6 }, android: { elevation: 2 } }) },
    ...
    tlCard:        { flex: 1, backgroundColor: colors.card, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, marginLeft: 8, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, ...Platform.select({ ios: { shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 1 }, shadowRadius: 4 }, android: { elevation: 2 } }) },
