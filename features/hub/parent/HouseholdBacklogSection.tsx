...
import { ClipboardList, AlertCircle, Car, PartyPopper } from 'lucide-react-native';
            ...
            {myLockedItems.map(a => {
              ...
              return (
                <View key={a.id} style={{
                  ...
                  backgroundColor: isDark ? `${colors.danger}10` : colors.dangerLight, padding: 12, flexDirection: 'row', gap: 10, alignItems: 'center',
                }}>
