...
// Fetches the same live legal_documents row every other Terms render site
// uses (useTermsContent()) rather than duplicating or inventing new legal
// text, but drops the accept checkbox/CTA — a signed-in user re-reading
// the terms from Settings isn't accepting them, just viewing them, and
// TermsScreen's own back button intentionally routes to /onboarding
// (wrong for a user who's already fully onboarded).
