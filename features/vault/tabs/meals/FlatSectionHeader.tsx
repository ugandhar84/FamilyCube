...
// Kept local to MealsTab's meals/ folder (no cross-feature import from
// features/hub) since this is the only vault tab currently adopting the flat
// pattern. Mirrors health/FlatSectionHeader.tsx and grocery/FlatSectionHeader.tsx.
