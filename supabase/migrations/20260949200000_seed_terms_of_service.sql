...
4.3 No use of your content to train third-party AI models without consent. We do not send your identifiable family data to a third-party AI provider for model-training purposes. See §8 for how the AI Assistant processes what you send it.
...
7.4 Data sharing. We do not sell your personal data. We share data only: with Supabase (our database/infrastructure and authentication provider); with third-party AI providers as described in §8 (the AI Assistant), scoped to what's needed to generate a response; with Apple, Google, or RevenueCat for subscription processing; with a successor entity in any merger or acquisition (§7.5); and where required by law or valid legal process.
...
8.1 Nature of the feature. The AI Assistant is an AI-powered assistant that can answer questions and help create or manage chores, events, and other in-app items from natural-language requests. It is powered by a third-party large language model.

8.2 Not professional advice. The AI Assistant is a convenience and organizational tool. It does not provide medical, legal, financial, or safety-critical advice, and nothing it generates should be treated as such. For any medical, legal, or emergency matter, consult an appropriate licensed professional or contact emergency services directly.

8.3 Accuracy. Like any AI system, the AI Assistant can occasionally produce inaccurate, incomplete, or nonsensical responses ("hallucinations"). Review anything the AI Assistant creates or suggests (e.g., a scheduled event, an assigned chore) before relying on it.

8.4 Data sent to the AI provider. When you use the AI Assistant, the text of your request and relevant context needed to answer it (such as your family's upcoming events or chore list) is sent to our third-party AI provider to generate a response. We configure this integration so that data is used only to generate your response, not to train the provider's general-purpose models. The provider's own terms govern their handling of data in transit to and processing by their systems.
